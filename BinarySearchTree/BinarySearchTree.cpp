...
public:
	...
	BinaryTree()
	{
		ROOT = NULL; //  Iniatializing ROOT to null
	}

	void insert(string element) // Insert a node in the binary search tree
	{
		Node* newNode = new Node(element, NULL, NULL); // Allocate memory for the new node
		newNode->info = element; // Assign value to the data field of new node
		...
		if (element < parent->info) // If the value in data field of the new node is less than that parents
		{
